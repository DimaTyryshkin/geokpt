...
{
	public class Kpt10Reader : KptReaderBase
	{
		...
		public readonly static string kptVersionNumber = "10";
		...
		public Kpt10Reader(XmlDocument doc)
		{
			...
			nsmgr.AddNamespace("adrOut4", "urn://x-artefacts-rosreestr-ru/commons/complex-types/address-output/4.0.1");
		}
		...
		public override List<IParcel> GetAllParcels()
		{
			...
			foreach (var percel in Parcels)
			{
				...
				r.Add(new Kpt10ParcelReader(e, nsmgr));
			}
